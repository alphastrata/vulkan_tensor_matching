...
fn main() {
    ...
    save_patch("test_data/debug_case0_gt.png", &gt0_patch, tmpl0.width, tmpl0.height);
    save_patch("test_data/debug_case0_ours.png", &our0_patch, tmpl0.width, tmpl0.height);
    save_patch("test_data/debug_case0_tmpl.png", &tmpl0_patch, tmpl0.width, tmpl0.height);
}
