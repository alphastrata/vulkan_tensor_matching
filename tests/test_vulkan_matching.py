...
class TestCPUvsOpenCV:
    ...
    def test_sse_matches_opencv_sqdiff(self):
        ...
        cpu_result = match_template_cpu(
            img_data, tmpl_data, MatchTemplateMethod.sum_of_squared_errors()
        )
    ...
    def test_cross_correlation_matches_opencv_ccorr(self):
        ...
        cpu_result = match_template_cpu(
            img_data, tmpl_data, MatchTemplateMethod.cross_correlation()
        )
        cpu_arr = image_data_to_numpy(cpu_result)
...
class TestVulkanGPU:
    ...
    def matcher(self):
        ...
        try:
            ...
            yield m
            # Explicitly delete the matcher to ensure Vulkan cleanup
            # happens before interpreter shutdown
            del m
