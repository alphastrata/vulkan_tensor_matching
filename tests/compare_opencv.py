...
print(f"\nGround Truth: ({gt_x}, {gt_y}) centre=({gt_cx}, {gt_cy})")
...
print(f"  Location: {max_loc} centre=({opencv_cx}, {opencv_cy})")
...
# Check OpenCV patch
opencv_patch = img_cv[
    max_loc[1] : max_loc[1] + tmpl_cv.shape[0],
    max_loc[0] : max_loc[0] + tmpl_cv.shape[1],
]
